...
VL_ATTR_COLD void Vcva5_sim_fifo_interface__D5___ctor_var_reset(Vcva5_sim_fifo_interface__D5* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vcva5_sim__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+                Vcva5_sim_fifo_interface__D5___ctor_var_reset\n"); );
    // Body
