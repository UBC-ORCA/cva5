...
import_files -norecurse $sources_dir/examples/zcu104/vxu_wrapper.sv
...
set_property -name "top_file" -value " ${sources_dir}/examples/zcu104/vxu_wrapper.sv" -objects $obj
...
set_property display_name VXU_ZCU104 [ipx::current_core]
set_property description VXU_ZCU104 [ipx::current_core]
...
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/mult32.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/operand_selector.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vAdd_mask.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vAdd_min_max.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vAdd_unit_block.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vAndOrXor.sv
...
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vFirst_Popc.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vMerge.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vMinMaxSelector.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vMul.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vNarrow.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vRedAndOrXor_unit_block.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vRedSum_Min_Max_unit_block.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vReduction.sv
import_files -force -fileset [get_filesets sources_1] $sources_dir/rvv-lite/src/vALU/vSlide.sv
...
import_files -force -fileset [get_filesets sources_1] $sources_dir/examples/zcu104/vxu_wrapper.sv
