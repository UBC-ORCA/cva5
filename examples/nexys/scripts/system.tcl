...
set_property ip_repo_paths [list $script_folder/cva5_nexys_wrapper] [current_project]
update_ip_catalog
...
make_wrapper -files [get_files $script_folder/${_xil_proj_name_}/${_xil_proj_name_}.srcs/sources_1/bd/system/system.bd] -top
add_files -norecurse $script_folder/${_xil_proj_name_}/${_xil_proj_name_}.gen/sources_1/bd/system/hdl/system_wrapper.v
