...
import_files -norecurse $origin_dir/../../cfu/crc_wrapper.sv -force
...
set obj [get_filesets sources_1]
set_property -name "top" -value "crc_wrapper" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${origin_dir}/cfu/crc_wrapper.sv" -objects $obj
